...
**Files:**
- Modify: `Context/Sources/ContextMCP/main.swift` — add 4 tool definitions to `toolsList()` and 4 handlers to `handleToolCall()`
...
Check: `grep -A5 "ContextMCP" Context/Package.swift` to see dependencies. If ContextMCP doesn't depend on Context, inline the HTTP call in the MCP handlers.
...
Run: `cd /Users/nicknorris/Documents/claude-code-projects/claude-context-tool/Context && swift build 2>&1`
...
Run: `cd /Users/nicknorris/Documents/claude-code-projects/claude-context-tool/Context && swift build && open .build/debug/Context.app`
