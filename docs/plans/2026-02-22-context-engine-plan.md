...
### Task 8: MCP Tool — context_search on ContextMCP
...
**Step 1: Add CodeChunk model to ContextMCP**
...
Run: `cd /Users/nicknorris/Documents/claude-code-projects/claude-context-tool/Context && swift build --product ContextMCP 2>&1`
...
Run: `cd /Users/nicknorris/Documents/claude-code-projects/claude-context-tool/Context && swift build --product ContextMCP 2>&1 && .build/debug/ContextMCP 2>/dev/null &; sleep 1; echo '{"jsonrpc":"2.0","id":1,"method":"tools/list"}' | timeout 2 cat - | head -1`
...
- `Context/Sources/ContextMCP/main.swift` (context_search tool)
